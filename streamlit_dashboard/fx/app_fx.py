...
with tab3:
    ...
    with col_b3:
        fast_ema = st.number_input("短期EMA", min_value=2, max_value=50, value=20, step=1, key="t3_fast")
        slow_ema = st.number_input("長期EMA", min_value=10, max_value=500, value=200, step=5, key="t3_slow")
